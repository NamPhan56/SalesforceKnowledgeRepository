...
import PICTUREZIPLOC from '@salesforce/resourceUrl/SharingStructureAndTools';

export default class AdminSharingStructureAndTools extends LightningElement {

    //Boolean tracked variable to indicate if modal is open or not default value is false as modal is closed when page is loaded 
    @track isModalOpen = false;

    buttonName = 'Sharing Structure and Tools'
    titleLink = '';
